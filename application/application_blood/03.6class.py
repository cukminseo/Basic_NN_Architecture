...
import random
from utils_6class import plot_confusion_matrix
from utils_6class import get_data_list
...
config.add_argument("--lr", default=0.0005, type=float) # 2번에서 임시 10배 # 3번에서 원래대로
